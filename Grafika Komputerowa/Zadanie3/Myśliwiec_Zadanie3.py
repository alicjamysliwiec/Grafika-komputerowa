...
def jajko():
    ...
    for u in range(N):
        for v in range(N-1):
            ...
            glColor3f(tablica_kolorow[u][v+1][0], tablica_kolorow[u][v+1][1], tablica_kolorow[u][v+1][2])
            glVertex3f(tablica_wierzcholkow[u][v+1][0], tablica_wierzcholkow[u][v+1][1] - 5, tablica_wierzcholkow[u][v+1][2])
            
            glColor3f(tablica_kolorow[(u+1) % N][v+1][0], tablica_kolorow[(u+1) % N][v+1][1], tablica_kolorow[(u+1) % N][v+1][2])
            glVertex3f(tablica_wierzcholkow[(u+1) % N][v+1][0], tablica_wierzcholkow[(u+1) % N][v+1][1] - 5, tablica_wierzcholkow[(u+1)%N][v+1][2])
            glColor3f(tablica_kolorow[(u+1) % N][v][0], tablica_kolorow[(u+1) % N][v][1], tablica_kolorow[(u+1) % N][v][2])
            glVertex3f(tablica_wierzcholkow[(u+1) % N][v][0], tablica_wierzcholkow[(u+1) % N][v][1] - 5, tablica_wierzcholkow[(u+1) % N][v][2])
            glColor3f(tablica_kolorow[u][v+1][0], tablica_kolorow[u][v+1][1], tablica_kolorow[u][v+1][2])
            glVertex3f(tablica_wierzcholkow[u][v+1][0], tablica_wierzcholkow[u][v+1][1] - 5, tablica_wierzcholkow[u][v+1][2])
    ...
    for u in range(N):
        glColor3f(tablica_kolorow[(N-u) % N][N-1][0], tablica_kolorow[(N-u) % N][N-1][1], tablica_kolorow[(N-u) % N][N-1][2])
        glVertex3f(tablica_wierzcholkow[(N-u) % N][N-1][0], tablica_wierzcholkow[(N-u) % N][N-1][1] - 5, tablica_wierzcholkow[(N-u) % N][N-1][2])
        glColor3f(tablica_kolorow[(N-u + 1) % N][N-1][0], tablica_kolorow[(N-u + 1) % N][N-1][1], tablica_kolorow[(N-u + 1) % N][N-1][2])
        glVertex3f(tablica_wierzcholkow[(N-u + 1) % N][N-1][0], tablica_wierzcholkow[(N-u + 1) % N][N-1][1] - 5, tablica_wierzcholkow[(N-u +1) % N][N-1][2])
        ...
        glVertex3f(tablica_wierzcholkow[(u-1) % N][0][0], tablica_wierzcholkow[(u-1) % N][0][1] - 5, tablica_wierzcholkow[(u-1) % N][0][2])
        glColor3f(tablica_kolorow[(N-u + 1) % N][N-1][0], tablica_kolorow[(N-u + 1) % N][N-1][1], tablica_kolorow[(N-u + 1) % N][N-1][2])
        glVertex3f(tablica_wierzcholkow[(N-u + 1) % N][N-1][0], tablica_wierzcholkow[(N-u + 1) % N][N-1][1] - 5, tablica_wierzcholkow[(N-u +1) % N][N-1][2])
        glColor3f(tablica_kolorow[u][0][0], tablica_kolorow[u][0][1], tablica_kolorow[u][0][2])
        glVertex3f(tablica_wierzcholkow[u][0][0], tablica_wierzcholkow[u][0][1] - 5, tablica_wierzcholkow[u][0][2])       
